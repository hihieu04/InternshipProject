...
-- Thêm dữ liệu vào bảng roles_auth
...
-- Thêm dữ liệu vào bảng user_information
INSERT INTO user_information (date_created, account_id, firstname, lastname, department_id) 
VALUES ('2024-08-22', 1, 'Admin', 'User', 1);
INSERT INTO user_information (date_created, account_id, firstname, lastname, department_id) 
VALUES ('2024-08-22', 2, 'Normal', 'User', 2);
INSERT INTO user_information (date_created, account_id, firstname, lastname, department_id) 
VALUES ('2024-08-22', 3, 'Normal', 'User', 2);
INSERT INTO user_information (date_created, account_id, firstname, lastname, department_id) 
VALUES ('2024-08-22', 5, 'Normal', 'User', 2);
-- Thêm dữ liệu vào bảng auth_token
...
VALUES 
(1, 1, 'Hoang Mai Hieu 1', 'Area 1', '2024-08-01', 1, 'Checked', 'John Doe', 'image1.jpg'),
(1, 2, 'Hoang Mai Hieu 2', 'Area 2', '2024-08-02', 1, 'Checked', 'Jane Smith', 'image2.jpg'),
(1, 3, 'Hoang Mai Hieu 3','Area 3', '2024-08-03', 0, 'Unchecked', 'Alice Johnson', 'image3.jpg'),
(1, 4, 'Hoang Mai Hieu 4','Area 4', '2024-08-04', 1, 'Checked', 'Bob Brown', 'image4.jpg'),
(1, 5, 'Hoang Mai Hieu 5','Area 5', '2024-08-05', 1, 'Unchecked', 'Charlie Davis', 'image5.jpg'),
(1, 6, 'Hoang Mai Hieu 6','Area 6', '2023-08-06', 1, 'Checked', 'Diana White', 'image6.jpg'),
(1, 7, 'Hoang Mai Hieu 7','Area 7', '2023-08-07', 0, 'Unchecked', 'Evan Green', 'image7.jpg'),
(1, 8, 'Hoang Mai Hieu 8','Area 8', '2023-08-08', 1, 'Checked', 'Fiona Black', 'image8.jpg'),
(1, 9, 'Hoang Mai Hieu 9', 'Area 9', '2023-08-09', 1, 'Checked', 'George King', 'image9.jpg'),
(3, 10, 'Hoang Mai Hieu 10','Area 10', '2023-08-10', 0, 'Unchecked', 'Hannah Lee', 'image10.jpg');
drop TABLE DateReport
drop TABLE MainRubber
drop TABLE SecondaryRubber
DROP COLUMN name;
...
-- Insert data into ReceptionReport
